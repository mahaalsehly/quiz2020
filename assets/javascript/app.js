...
function rSummary(){
    var alldone = $('<h2>').html('تمت الاجابات ..!');
    var canswers = $('<p>').html('الاجابات الصحيحة: ' + gcount);
    var wanswers = $('<p>').html('الاجابات الخاطئة !: ' + wcount);
    var cunanswered = $('<p>').html('لم تتم الاجابة عليها : ' + unanswered);
